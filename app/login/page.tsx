...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-amber-100 to-white px-6 font-sans">
      <Image src="/logo-homixia.png" alt="Homixia" width={80} height={80} className="mb-4" />
      <h1 className="text-2xl font-bold text-amber-600 mb-6">Connexion Admin 🔐</h1>
      ...
      >
        ...
        {message && <p className="text-center text-sm text-amber-600">{message}</p>}
